...
#define SERVO_BASE_PIN      17 // 17 base
#define SERVO_BRACO_PIN     19 // 19 braco 
#define SERVO_GARRA_PIN     18 // 18 garra
#define SERVO_ANGULO_PIN    16 // 16 angulo 

// --- LIMITES DE MOVIMENTO DOS SERVOS (em graus) ---
#define BASE_MIN_ANGLE      20.0f
...
#define GARRA_MIN_ANGLE     0.0f  // (90 - 60/2)
#define GARRA_MAX_ANGLE     150.0f // (90 + 60/2) -> Total de 60° de movimento

#define ANGULO_MIN_ANGLE    10.0f  // (90 - 40/2)
#define ANGULO_MAX_ANGLE    180.0f // (90 + 40/2) -> Total de 40° de movimento
